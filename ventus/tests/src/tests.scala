...
class AdvancedTest extends AnyFreeSpec with ChiselScalatestTester{ // Working in progress
  ...
  //             c.clock.step(1)
  //           }
  //         }validvvadsfasfvfdasfdasfva
  //       }.join
  //     }.join
  //   }
  // }

  "adv_test_mma_0barrier" in {
    import TestUtils._
    val iniFile = new IniFile("./ventus/txt/_cases.ini")
    val defaultCaseName ="mma_0barrier"//: String = iniFile.sections("")("Default").head
    val section = iniFile.sections(defaultCaseName)
...
//      c.clock.setTimeout(6000)
  ...
  "adv_test_mma" in {
    import TestUtils._
    val iniFile = new IniFile("./ventus/txt/_cases.ini")
    val defaultCaseName ="mma_new_1"//: String = iniFile.sections("")("Default").head
    val section = iniFile.sections(defaultCaseName)
  ...
  "adv_test_mma_fixNum V2" in {
    import TestUtils._
    val iniFile = new IniFile("./ventus/txt/_cases.ini")
    val defaultCaseName ="mma_fixNum"//: String = iniFile.sections("")("Default").head
    val section = iniFile.sections(defaultCaseName)
  ...
  "adv_test_mma_fixNum V2 mixedPrec" in {
    import TestUtils._
    val iniFile = new IniFile("./ventus/txt/_cases.ini")
    val defaultCaseName ="mma_fixNum"//: String = iniFile.sections("")("Default").head
    val section = iniFile.sections(defaultCaseName)
  ...
  import TestUtils._
  val iniFile = new IniFile("./ventus/txt/_cases.ini")
  val defaultCaseName ="tc_old"///: String = iniFile.sections("")("Default").head
  val section = iniFile.sections(defaultCaseName)
