...
//import TensorCore.{TC_MMAInput_MixedPrecision, TC_MMAOutput,  vTCData, TensorCore_MixedPrecision_multslot}//TensorCore_MixedPrecision,
//import chisel3._
...
//
//class MMA_Test extends AnyFlatSpec with ChiselScalatestTester {
...
//  }
//
//  behavior of "Tensor Core MMA mult-slot"
//  it should "TCComputationArray 888 FP16" in {
//    test(new TensorCore_MixedPrecision_multslot(8,8,8,3,16,new TCCtrl(32, 3))).withAnnotations(Seq(WriteVcdAnnotation)) { d =>
//      TCMMA888Input.reset
//      d.io.in.initSource()
