...
object GPGPU_gen extends App{
  ...
  (new chisel3.stage.ChiselStage).emitVerilog(new GPGPU_top()(L1param, SV = Some(mmu.SV32)),Array("--emission-options=disableMemRandomization,disableRegisterRandomization"))
}
