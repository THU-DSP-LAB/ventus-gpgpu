...
object Instructions {
  ...
  //518
  def CP_ASYNC_COPYSIZE = BitPat("b00000?????????????000?????1000001")

  def CP_ASYNC_BULK = BitPat("b00000?????????????001?????1000001")

  def CP_ASYNC_TENSOR = BitPat("b00000?????????????011?????1000001")

  def CP_ASYNC_FENCE = BitPat("b00000?????????????100?????1000001")

  def TC_MMA = BitPat("b00000?????????????100?????1100001")
