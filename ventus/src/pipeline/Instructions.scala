...
object Instructions {
  ...
  def VLB12_V            = BitPat("b?????????????????000?????0000111")
  def VLB_V              = BitPat("b0????????????????000?????0101011")
  def VLBU12_V           = BitPat("b?????????????????100?????0000111")
  ...
  def VLH12_V            = BitPat("b?????????????????111?????0000111")
  def VLH_V              = BitPat("b0????????????????001?????0101011")
  def VLHU12_V           = BitPat("b?????????????????101?????0000111")
  ...
  def VLW12_V            = BitPat("b?????????????????110?????0000111")
  ...
  def VSB12_V            = BitPat("b?????????????????000?????0100111")
  ...
  def VSH12_V            = BitPat("b?????????????????111?????0100111")
  ...
  def VSW12_V            = BitPat("b?????????????????110?????0100111")
