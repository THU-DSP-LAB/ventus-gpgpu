...
object Instructions {
  def REGEXT             = BitPat("b????????????00000010000000001011")
  def REGEXTI            = BitPat("b????????????00000011000000001011")
  def VADD12_VI          = BitPat("b?????????????????000?????0001011")
  def VSUB12_VI          = BitPat("b?????????????????001?????0001011")
  def VFTTA_VV           = BitPat("b000011???????????010?????0001011")
  def VHTTA_VV           = BitPat("b000001???????????010?????0001011")
  def VBTTA_VV           = BitPat("b000010???????????010?????0001011")
  def VFEXP_V            = BitPat("b000100???????????010?????0001011")
  def VBEQ               = BitPat("b?????????????????000?????0001011")
  def VBNE               = BitPat("b?????????????????001?????0001011")
  def VBLT               = BitPat("b?????????????????100?????0001011")
  def VBGE               = BitPat("b?????????????????101?????0001011")
  def VBLTU              = BitPat("b?????????????????110?????0001011")
  def VBGEU              = BitPat("b?????????????????111?????0001011")
  def JOIN               = BitPat("b?????????????????011?????0001011")
  def BARRIER            = BitPat("b0000001??????????010?????0001011")//0200200b
  def ENDPRG             = BitPat("b0000000??????????010?????0001011")//0000200b
  //nop 0000 0013 addi x0 0 x0
