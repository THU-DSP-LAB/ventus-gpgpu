...
object Instructions {
  ...
  def VFCVT_F_H_V        = BitPat("b010010??????11000001?????1010111")
  def VFCVT_H_F_V        = BitPat("b010010??????11001001?????1010111")
...
//  def VFCVT_F_H_V        = BitPat("b010010??????01001001?????0100001")
  ...
  // tc update
  def TC_MMA             = BitPat("b0000??????????????10??????0001010")
  ...
  def VSHUFFLE_DOWN      = BitPat("b001011???????????001?????1000010")
