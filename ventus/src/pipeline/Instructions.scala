...
object Instructions {
  ...
  def VFCVT_H_F_V        = BitPat("b010010??????01000001?????1010111")
  def VFCVT_F_H_V        = BitPat("b010010??????01001001?????1010111")
//  def VFCVT_H_F_V        = BitPat("b010010??????01000001?????0100001")
//  def VFCVT_F_H_V        = BitPat("b010010??????01001001?????0100001")
  ...
  // tc update
  def TC_MMA             = BitPat("b0000??????????????10??????1100001")
  ...
  def VSHUFFLE_DOWN      = BitPat("b001011???????????001?????1010111")
